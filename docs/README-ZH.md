...
- 用 zarrow 生成 REE fixture：`zig build interop-fixture-writer -- .interop-fixtures/zarrow_ree.arrow ree`
- 用 zarrow 校验 REE fixture：`zig build interop-fixture-check -- .interop-fixtures/pyarrow_ree.arrow ree`
